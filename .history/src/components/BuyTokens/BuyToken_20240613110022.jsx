...
import { GiGorilla } from 'react-icons/gi'; // Importing gorilla icon for $HarambeAI Tokens
      ...
      <div className="flex w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="w-1/2 bg-[#f5f5dc] p-8 flex flex-col items-center">
          <div className="text-center mb-4">
            <GiGorilla className="text-6xl mb-2" />
          ...
          <div className="w-full mb-4">
            <div className="flex justify-between items-center border-b border-gray-300 pb-2 mb-2">
              <div className="text-gray-700 flex items-center"><GiGorilla className="text-xl mr-2" /> $HarambeAI Tokens</div>
        ...
        <div className="w-1/2 p-8 bg-white">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center">
              <FaDollarSign className="text-xl mr-2 text-blue-500" /> USDC (500.000000)
            </div>
          </div>
