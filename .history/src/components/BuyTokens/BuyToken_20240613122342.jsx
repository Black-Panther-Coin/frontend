...
const BuyToken = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#f5f5dc]">
      <div className="w-full flex justify-center items-center bg-pink-500 text-white py-2">
        <span>Quote expires in <span className="font-bold">57:52</span></span>
      </div>
      <div className="flex w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden mt-4">
        <div className="w-1/2 bg-[#f5f5dc] p-8 flex flex-col items-center">
          ...
          <div className="w-full mb-4">
            <div className="flex justify-between items-center border-b border-gray-300 pb-2 mb-2">
              ...
              <div className="font-semibold text-purple-950">146.19883</div>
            </div>
            <div className="flex justify-between items-center border-b border-gray-300 pb-2 mb-6">
              ...
              <div className="font-semibold text-purple-950">$50</div>
            </div>
          </div>
        ...
        <div className="w-1/2 p-8 bg-white">
          <div className="text-right text-sm text-gray-500 mb-6">
            Quote expires in <span className="font-bold text-gray-800">57:52</span>
          </div>
          <div className="mb-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center mb-2">
              <FontAwesomeIcon icon={faEthereum} className="text-xl mr-2 text-purple-950" /> ETH (0.014267)
            </div>
            <div className="flex items-center mb-2">
              <FontAwesomeIcon icon={faDollarSign} className="text-xl mr-2 text-green-500" /> USDT (50.000000)
            </div>
            <div className="flex items-center">
              <FontAwesomeIcon icon={faDollarSign} className="text-xl mr-2 text-blue-500" /> USDC (50.000000)
            </div>
          </div>
