...
import { faEthereum, faTether, faUsd } from '@fortawesome/free-brands-svg-icons';
import { faGorilla } from '@fortawesome/free-solid-svg-icons'; // Importing gorilla icon
      ...
      <div className="flex w-full max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="w-1/2 bg-[#f5f5dc] p-8 flex flex-col items-center">
          <div className="text-center mb-4">
            <FontAwesomeIcon icon={faGorilla} className="text-6xl mb-2" />
          ...
          <div className="w-full mb-4">
            <div className="flex justify-between items-center border-b border-gray-300 pb-2 mb-2">
              <div className="text-gray-700 flex items-center">
                <FontAwesomeIcon icon={faGorilla} className="text-xl mr-2" /> $HarambeAI Tokens
              </div>
        ...
        <div className="w-1/2 p-8 bg-white">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center mb-2">
              <FontAwesomeIcon icon={faTether} className="text-xl mr-2 text-green-500" /> USDT (500.000000)
            </div>
            <div className="flex items-center">
              <FontAwesomeIcon icon={faUsd} className="text-xl mr-2 text-blue-500" /> USDC (500.000000)
            </div>
          </div>
