...
function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      ...
      <div className="absolute bottom-8 right-8 bg-purple-800 p-6 rounded-lg mb-8 shadow-lg w-full max-w-xs md:max-w-sm flex flex-col items-center justify-center">
        ...
        <div className="mt-4 text-center">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <div className="flex mt-2">
              ...
              <input type="text" className="border rounded-r px-4 py-2w-40 h-20  bg-lightbaige" placeholder="$ BPNTHR" />
            </div>
            <button className="bg-orange-500 text-white py-2 px-4 rounded mt-4 hover:bg-purple-800 focus:outline-none">
              Proceed to Buy
            </button>
          </div>
