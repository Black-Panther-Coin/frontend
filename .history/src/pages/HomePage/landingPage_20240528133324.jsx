  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      >
        ...
        <div className="absolute bottom-4 right-4 bg-white p-6 rounded-lg shadow-lg w-full max-w-xs md:max-w-sm">
          <button className="absolute top-4 right-4 bg-purple-500 text-white py-2 px-4 rounded hover:bg-purple-600 focus:outline-none">
            Connect Wallet
          </button>
          <div className="mt-12">
