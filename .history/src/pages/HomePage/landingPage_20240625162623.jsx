    ...
    <div className="relative flex flex-col lg:flex-row justify-center items-stretch space-y-8 lg:space-y-0 lg:space-x-8">
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center text-center relative mb-8 lg:mb-0 z-10 transform transition-transform duration-200 hover:scale-105 animate-slideInLeft">
        <div className="relative flex items-center justify-center mb-4">
          <div className="w-20 h-20 rounded-full border-4 border-yellow-400 absolute animate-rotate"></div>
          <div className="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center text-purple-800 text-2xl font-bold">
            01
          </div>
        </div>
