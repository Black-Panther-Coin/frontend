...
function LandingPage() {
  ...
  return (
    <>
      ...
      <img src="harambe.jpg" alt="Harambe Monkey" className="w-full h-48 object-cover" />
      <div className="p-4">
        <h3 className="text-xl font-bold text-gray-800">Harambe Is Set To Rock The Charts</h3>
        <p className="text-base text-gray-600">With a Whopping 100% ROI (This Year Alone!)</p>
        <p className="text-base text-gray-600">Each successful trade triggers the purchase and immediate burning of Harambe Tokens, increasing demand, reducing supply, and driving prices to the moon.</p>
        <a href="#" className="inline-flex items-center px-4 py-2 bg-yellow-500 text-white font-bold rounded hover:bg-yellow-700 focus:outline-none">
          GET MY TOKENS
        </a>
        <p className="text-sm text-gray-600 mt-2">1 HARAMBE AI = $ 0.309 USD</p>
