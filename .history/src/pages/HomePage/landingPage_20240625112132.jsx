...
import './homePage.css';  // Make sure to include the path to your CSS file

const RoadMap = () => (
  <section className="roadmap-section">
    <h2 className="roadmap-heading">Our Roadmap</h2>
    <div className="roadmap-container lg:roadmap-container-lg">

      {/* Phase 1: Initial Traction */}
      <div className="roadmap-phase">
        <div className="roadmap-phase-number">01</div>
        <h3 className="roadmap-phase-title">VALUES</h3>
        <FaRocket className="roadmap-phase-icon" />
        <p className="roadmap-phase-subtitle">Initial Traction</p>
        <p className="roadmap-phase-timeline">(Months 1-6)</p>
        <p className="roadmap-phase-text">Capture the community's imagination and support through the BPNTHR meme coin launch.</p>
        <div className="roadmap-phase-key-activities">
      ...
      <div className="roadmap-phase">
        ...
        <h3 className="roadmap-phase-title">VISION</h3>
        <FaCogs className="roadmap-phase-icon" />
        <p className="roadmap-phase-subtitle">Ecosystem Development</p>
        <p className="roadmap-phase-timeline">(Months 4-12)</p>
        <p className="roadmap-phase-text">Solidify the project's foundation and core functionalities:</p>
        <div className="roadmap-phase-key-activities">
          <h5>Key Activities:</h5>
          <ul>
      ...
      <div className="roadmap-phase">
        ...
        <h3 className="roadmap-phase-title">MISSION</h3>
        <FaLightbulb className="roadmap-phase-icon" />
        <p className="roadmap-phase-subtitle">Expansion and Sustainability</p>
        <p className="roadmap-phase-timeline">(Months 13-24)</p>
        <p className="roadmap-phase-text">Expand the Black Panther ecosystem and establish long-term financial viability:</p>
        <div className="roadmap-phase-key-activities">
          <h5>Key Activities:</h5>
          <ul>
