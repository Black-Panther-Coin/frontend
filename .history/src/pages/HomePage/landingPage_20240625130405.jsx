    ...
    <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4">
      <div className="lg:w-1/2 text-center lg:text-left">
        ...
        <p className="text-white text-base lg:text-lg leading-relaxed text-justify">
          The Black Panther Token is not just a digital asset; it represents a movement towards a more inclusive and financially empowered Africa. With its strategic roadmap and the backing of tangible projects, BPNTHR is set to revolutionize the cryptocurrency space in the continent.
        </p>
