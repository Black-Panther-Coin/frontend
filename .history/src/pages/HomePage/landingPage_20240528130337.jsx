    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      >
        <div className="flex flex-col justify-start items-center h-full pt-20 md:pt-24 lg:pt-32 xl:pt-40">
          <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-purple-800 text-center px-4">
            Black Panther Token (<span className="text-orange-600">BPNTHR</span>) Pre-Sale is live
          </h1>
