...
function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      ...
      <div className="absolute bottom-8 right-80 bg-purple-800 p-6 rounded-lg h-40 shadow-lg w-full max-w-xs md:max-w-sm flex flex-col items-center justify-center">
