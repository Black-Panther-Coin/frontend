...
<div className="mx-auto w-full px-4 bg-lightbaige">
    <div className="flex flex-col items-center justify-center h-full text-center">
        <img src={pantherImage} alt="Black Panther" className="w-32 h-auto mb-4" />
        <button className="bg-purple-600 text-white py-2 px-4 font-bold rounded hover:bg-purple-800 focus:outline-none relative z-10">
            Learn More
        </button>
    </div>
</div>
