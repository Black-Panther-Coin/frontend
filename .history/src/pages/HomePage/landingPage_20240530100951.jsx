  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      ...
      <div className="absolute bottom-8 right-8 bg-purple-800 p-6 rounded-lg shadow-lg w-full max-w-xs md:max-w-sm flex flex-col items-center justify-center">
        <button className="bg-orange-500 text-white py-2 px-4 rounded hover:bg-orange-600 focus:outline-none relative z-10">
          Connect Wallet
        </button>
        <div className="mt-4 text-center">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <button className="bg-orange-500 text-white py-2 px-4 rounded mt-6 hover:bg-purple-800 focus:outline-none relative z-10">
              Proceed to Buy
            </button>
          </div>
