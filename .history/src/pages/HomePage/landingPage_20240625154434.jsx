  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden bg-lightbeige">
      ...
      <div ref={sceneEl} className="absolute inset-0 z-0">
        <div data-depth="0.2" className="shape absolute top-10 left-10 w-16 h-16 bg-purple-600 opacity-50 rounded-full mix-blend-multiply"></div>
        <div data-depth="0.3" className="shape absolute bottom-10 right-10 w-24 h-24 bg-yellow-400 opacity-50 rounded-full mix-blend-multiply"></div>
        <div data-depth="0.4" className="shape absolute top-1/4 left-1/3 w-20 h-20 bg-purple-300 opacity-50 rounded-full mix-blend-multiply"></div>
        <div data-depth="0.5" className="shape absolute bottom-1/3 right-1/4 w-12 h-12 bg-yellow-500 opacity-50 rounded-full mix-blend-multiply"></div>
      </div>
