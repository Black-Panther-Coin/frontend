...
function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      ...
      {/* New section */}
      <div className="flex justify-between items-center mt-16 mx-auto max-w-4xl px-4">
        <div className="w-1/2">
          <h2 className="text-2xl font-bold text-purple-950 mb-4">New Section Title</h2>
          <p className="text-base text-purple-950">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vel metus ac risus convallis vehicula nec eget nulla. Proin non quam quam. Integer in ex vel ante condimentum placerat. Sed ullamcorper lacus non nibh sagittis, vitae convallis elit ultricies.</p>
        </div>
        <div className="w-1/2">
          <img src={pantherImage} alt="Black Panther" className="w-full h-auto" />
        </div>
      </div>
    </div>
  );
