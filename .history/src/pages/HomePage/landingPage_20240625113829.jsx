  ...
  <section className="bg-gray-100 py-12 px-6 md:px-16 lg:px-24 text-gray-800">
    ...
    <div className="flex flex-col lg:flex-row justify-center items-stretch space-y-8 lg:space-y-0 lg:space-x-8">
      ...
      <div className="bg-white rounded-lg p-6 shadow-md flex flex-col items-center text-center relative mb-8 lg:mb-0">
        <div className="bg-purple-500 text-white text-2xl font-bold rounded-full w-16 h-16 flex items-center justify-center mb-4">
          01
        </div>
        <h3 className="text-2xl font-bold mb-4 text-purple-500">VALUES</h3>
        <FaRocket className="w-16 h-16 text-purple-500 mb-4" />
        <p className="text-lg font-semibold mb-4">Initial Traction</p>
        <p className="text-gray-600 mb-4">(Months 1-6)</p>
        <div className="space-y-4">
          <div>
            <h5 className="text-lg font-bold text-purple-500">Meme Coin Launch</h5>
            <p className="text-gray-700">Capture the community's imagination and support through the BPNTHR meme coin launch.</p>
          </div>
          <div>
            <h5 className="text-lg font-bold text-purple-500">Key Activities:</h5>
          ...
          <div>
            <h5 className="text-lg font-bold text-purple-500">Charity Wallet</h5>
      ...
      <div className="bg-white rounded-lg p-6 shadow-md flex flex-col items-center text-center relative mb-8 lg:mb-0">
        ...
        <h3 className="text-2xl font-bold mb-4 text-purple-500">VISION</h3>
        <FaCogs className="w-16 h-16 text-purple-500 mb-4" />
        <p className="text-lg font-semibold mb-4">Ecosystem Development</p>
        <p className="text-gray-600 mb-4">(Months 4-12)</p>
        <div className="space-y-4">
          <div>
            <p className="text-lg font-bold text-purple-500">Solidify the project's foundation and core functionalities:</p>
          </div>
          <div>
            <h5 className="text-lg font-bold text-purple-500">Key Activities:</h5>
            <ul className="list-disc list-inside text-gray-700">
      ...
      <div className="bg-white rounded-lg p-6 shadow-md flex flex-col items-center text-center relative">
        ...
        <h3 className="text-2xl font-bold mb-4 text-purple-500">MISSION</h3>
        <FaLightbulb className="w-16 h-16 text-purple-500 mb-4" />
        <p className="text-lg font-semibold mb-4">Expansion and Sustainability</p>
        <p className="text-gray-600 mb-4">(Months 13-24)</p>
        <div className="space-y-4">
          <div>
            <p className="text-lg font-bold text-purple-500">Expand the Black Panther ecosystem and establish long-term financial viability:</p>
          </div>
          <div>
            <h5 className="text-lg font-bold text-purple-500">Key Activities:</h5>
            <ul className="list-disc list-inside text-gray-700">
