...
function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      {/* Panther Image */}
      <div className="absolute top-0 left-0 w-full md:w-1/3 flex justify-center items-center">
        <img src={pantherImage} alt="Left Side Image" className="h-auto md:h-full object-contain" />
      </div>

      {/* Main Content */}
      <div className="flex flex-col justify-center items-center h-full text-center mt-16 mx-auto max-w-md">
      ...
      {/* Card Section */}
      <div className="absolute bottom-8 right-4 md:right-24 bg-purple-950 p-6 rounded-lg shadow-lg w-full max-w-md mx-auto flex flex-col items-center justify-center">
