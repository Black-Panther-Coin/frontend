...
const RoadMap = () => (
  <section className="bg-purple-950 py-12 px-6 md:px-16 lg:px-24 text-white">
    <h2 className="text-4xl font-bold text-center text-yellow-500 mb-12 animate-slideInRight">Our Roadmap</h2>
    <div className="relative flex flex-col lg:flex-row justify-center items-stretch space-y-8 lg:space-y-0 lg:space-x-8">
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center text-center relative mb-8 lg:mb-0 z-10 transform transition-transform duration-200 hover:scale-105 animate-slideInLeft">
        <div className="relative flex items-center justify-center mb-4">
          <svg className="absolute w-24 h-24">
            <circle cx="12" cy="12" r="10" fill="transparent" stroke="#F6E05E" strokeWidth="4" className="animate-dash" />
          </svg>
          <div className="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center text-purple-800 text-2xl font-bold z-10 relative">
            01
          </div>
        </div>
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center text-center relative mb-8 lg:mb-0 z-10 transform transition-transform duration-200 hover:scale-105 animate-slideInRight">
        <div className="relative flex items-center justify-center mb-4">
          <div className="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center text-purple-800 text-2xl font-bold z-10 relative">
            02
          </div>
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center text-center relative z-10 transform transition-transform duration-200 hover:scale-105 animate-slideInLeft">
        <div className="relative flex items-center justify-center mb-4">
          <div className="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center text-purple-800 text-2xl font-bold z-10 relative">
            03
          </div>
