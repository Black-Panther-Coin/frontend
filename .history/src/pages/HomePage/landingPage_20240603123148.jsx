  ...
  return (
    <>
      ...
      <div className="container mx-auto flex flex-wrap justify-around mt-8">
        <div className="flex-1 flex justify-center items-center bg-purple-800 rounded-lg shadow-md m-2 p-4 text-center">
          <FontAwesomeIcon icon={faTelegram} size="2x" className="text-yellow-500" />
        </div>
        <div className="flex-1 flex justify-center items-center bg-purple-800 rounded-lg shadow-md m-2 p-4 text-center">
          <FontAwesomeIcon icon={faTwitter} size="2x" className="text-yellow-500" />
        </div>
        <div className="flex-1 flex justify-center items-center bg-purple-800 rounded-lg shadow-md m-2 p-4 text-center">
          <FontAwesomeIcon icon={faDiscord} size="2x" className="text-yellow-500" />
        </div>
        <div className="flex-1 flex justify-center items-center bg-purple-800 rounded-lg shadow-md m-2 p-4 text-center">
          <FontAwesomeIcon icon={faTiktok} size="2x" className="text-yellow-500" />
        </div>
        <div className="flex-1 flex justify-center items-center bg-purple-800 rounded-lg shadow-md m-2 p-4 text-center">
          <FontAwesomeIcon icon={faInstagram} size="2x" className="text-yellow-500" />
        </div>
      </div>
    </section>
