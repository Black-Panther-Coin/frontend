...
const Header = () => {
  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden bg-lightbeige">
      {/* Background graphics with parallax effect */}
      <div ref={sceneEl} className="absolute inset-0 z-0">
        <div data-depth="0.2" className="shape absolute top-10 left-10 w-16 h-16 bg-purple-600 opacity-50 rounded-full mix-blend-multiply animate-pulse"></div>
        <div data-depth="0.3" className="shape absolute bottom-10 right-10 w-24 h-24 bg-yellow-400 opacity-50 rounded-full mix-blend-multiply animate-bounce"></div>
        <div data-depth="0.4" className="shape absolute top-1/4 left-1/3 w-20 h-20 bg-purple-300 opacity-50 rounded-full mix-blend-multiply animate-pulse"></div>
        <div data-depth="0.5" className="shape absolute bottom-1/3 right-1/4 w-12 h-12 bg-yellow-500 opacity-50 rounded-full mix-blend-multiply animate-bounce"></div>
        <div data-depth="0.6" className="shape absolute top-1/3 left-1/4 w-14 h-14 bg-purple-500 opacity-50 rounded-full mix-blend-multiply animate-ping"></div>
        <div data-depth="0.7" className="shape absolute bottom-1/4 right-1/3 w-18 h-18 bg-yellow-300 opacity-50 rounded-full mix-blend-multiply animate-spin-slow"></div>
        <div data-depth="0.8" className="shape absolute top-1/2 left-1/2 w-10 h-10 bg-purple-400 opacity-50 rounded-full mix-blend-multiply animate-pulse"></div>
        <div data-depth="0.9" className="shape absolute bottom-1/2 right-1/2 w-16 h-16 bg-yellow-200 opacity-50 rounded-full mix-blend-multiply animate-bounce"></div>
      </div>

      {/* Content */}
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center mt-8">
      ...
      {/* Action bar */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 lg:left-auto lg:right-24 lg:translate-x-0 bg-purple-950 p-6 rounded-lg shadow-lg w-full max-w-md mx-auto flex flex-col items-center justify-center cursor-pointer">
        ...
        <div className="mt-4 text-center">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <div className="flex mt-2">
              <input type="text" className="border text-black font-bold rounded-l px-4 py-2 w-full md:w-40 h-12 bg-lightbeige" placeholder="USD" />
              <input type="text" className="border text-black font-bold rounded-r px-4 py-2 w-full md:w-40 h-12 bg-lightbeige" placeholder="$ BPNTHR" />
            </div>
        ...
        <button className="bg-lightbeige text-black py-2 px-4 font-bold rounded mt-6 hover:bg-purple-800 focus:outline-none relative z-10">
          White Paper
        </button>

        {/* Background overlay */}
        <div className="absolute inset-0 bg-transparent border-2 border-purple-800 rounded-lg"></div>
      </div>
    </div>
  );
};
