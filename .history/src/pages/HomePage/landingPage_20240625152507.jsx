  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* You can adjust these styles to fit your desired background */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-950 to-yellow-500 opacity-60"></div>
        <img
          src="/src/assets/images/background-image.jpg"
          alt="Background"
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center mt-8">
        <div className="lg:w-1/2 lg:mx-auto mb-4 lg:mb-8">
          ...
          <p className="mt-2 sm:mt-4 text-base text-white font-semibold">A MEME COIN WITH PURPOSE!</p>
        </div>
