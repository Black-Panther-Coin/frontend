        ...
        <div className="mt-4 text-center">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <div className="flex mt-2 space-x-2">
              <input type="text" className="border text-black font-bold rounded-l px-4 py-3 w-full md:w-40 h-14 bg-lightbeige focus:outline-none" placeholder="USD" />
              <input type="text" className="border text-black font-bold rounded-r px-4 py-3 w-full md:w-40 h-14 bg-lightbeige focus:outline-none" placeholder="$ BPNTHR" />
            </div>
