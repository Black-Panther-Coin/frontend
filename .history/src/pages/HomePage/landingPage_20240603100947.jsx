...
function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      ...
      <div className="absolute bottom-8 left-24 flex items-end">
        <img src={pantherImage} alt="Black Panther" className="w-48 mr-8 mb-8" />
        <div className="bg-purple-950 p-6 rounded-lg shadow-lg w-full max-w-md flex flex-col items-center justify-center">
