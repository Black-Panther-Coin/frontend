...
function LandingPage() {
  ...
  return (
    <>
      ...
      {/* New card */}
      <div className="bg-purple-800 rounded-lg shadow-md overflow-hidden max-w-md mx-auto flex flex-col items-center justify-center">
  <img src={pantherImage} alt="panther" className="w-full h-48 object-cover" />
  <div className="p-4 flex flex-col ">  
  <h3 className="text-xl font-bold text-white text-left">Black Panther Is Set To Rock The Charts</h3>
    <p className="text-base text-white text-left">With a Whopping 100% ROI (This Year Alone!)</p>
    ...
    <a href="#" className="inline-flex items-center px-4 py-2 bg-yellow-500 text-black font-bold rounded hover:bg-yellow-700 focus:outline-none">
      GET MY TOKENS
    </a>
    <p className="text-sm text-white mt-2">1 Panther AI = $ 0.309 USD</p>
    <p className="text-sm text-white mt-1">Hurry - Token price increases on May 25th!</p>
  </div>
</div>
