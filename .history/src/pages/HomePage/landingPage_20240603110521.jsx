...
function LandingPage() {
  const contractAddress = "0x1234567890abcdef"; // Example contract address, replace with your actual address
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 lg:left-auto lg:right-24 lg:translate-x-0 bg-purple-950 p-6 rounded-lg shadow-lg w-full max-w-md mx-auto flex flex-col items-center justify-center">
          ...
          <div className="mt-4 text-center">
            <div className="flex justify-center items-center">
              <h2 className="text-8xl font-bold text-yellow-500 mb-4 text-center">BPNTHR</h2>
              <span
            ...
            <p className="text-sm text-purple-200">{contractAddress}</p>
