...
const Header = () => (
  <div className="relative min-h-[70vh] overflow-hidden bg-lightbaige">
    <div className="flex flex-col justify-center items-center h-full text-center mt-8">
      <div className="w-11/12 lg:w-1/2 lg:mx-auto mb-4 lg:mb-8">
    ...
    <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 lg:left-auto lg:right-24 lg:translate-x-0 bg-purple-950 p-6 rounded-lg shadow-lg w-11/12 max-w-md mx-auto flex flex-col items-center justify-center">
      ...
      <div className="mt-4 text-center">
        ...
        <div className="mt-4 flex flex-col items-center">
          ...
          <div className="flex mt-2 w-full justify-center">
            <input type="text" className="border text-black font-bold rounded-l px-4 py-2 w-1/2 md:w-40 h-12 bg-lightbaige" placeholder="USD" />
            <input type="text" className="border text-black font-bold rounded-r px-4 py-2 w-1/2 md:w-40 h-12 bg-lightbaige" placeholder="$ BPNTHR" />
          </div>
...
const PantherSection = () => (
  <div className="bg-purple-800 rounded-lg shadow-md overflow-hidden max-w-7xl mx-auto my-8 p-4 flex flex-col lg:flex-row lg:items-start lg:space-x-8">
    <div className="lg:w-1/2 text-center lg:text-left p-4">
      <h2 className="text-yellow-500 font-bold text-4xl mb-2">WHAT IS BLACK PANTHER TOKEN?</h2>
      <p className="text-white text-lg mb-4 text-justify">
        Black Panther Token is a meme token created to drive awareness and education in the Web3/Blockchain space, leveraging the powerful symbol of the Black Panther.
      </p>
    </div>
    <div className="lg:w-1/2 text-center lg:text-left p-4">
      <h2 className="text-yellow-500 font-bold text-4xl mb-2">MISSION</h2>
      <p className="text-white text-lg mb-4 text-justify">
        To provide a platform that encourages health and wellness, educates people about alternative treatments including food as medicine, and brings new participants into the crypto space.
      </p>
    </div>
  </div>
);
...
const TokenomicsSection = () => (
  <div className="w-full mx-auto flex justify-center bg-purple-900">
    <Tokenomics />
  </div>
);
