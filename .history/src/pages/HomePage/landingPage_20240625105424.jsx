...
const RoadMap = () => (
  <section className="bg-purple-950 py-12 px-6 md:px-16 lg:px-24 text-white">
    ...
    <div className="relative flex flex-col lg:flex-row justify-center items-stretch space-y-8 lg:space-y-0 lg:space-x-8">
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center phase">
        ...
        <h3 className="text-2xl font-bold mb-4 text-center text-yellow-400">Initial Traction</h3>
        <h4 className="text-xl font-semibold mb-4 text-center text-yellow-300">(Months 1-6)</h4>
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center phase">
        ...
        <h3 className="text-2xl font-bold mb-4 text-center text-yellow-400">Ecosystem Development</h3>
        <h4 className="text-xl font-semibold mb-4 text-center text-yellow-300">(Months 4-12)</h4>
        <div className="space-y-4 text-center">
          <div>
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center phase">
        ...
        <h3 className="text-2xl font-bold mb-4 text-center text-yellow-400">Expansion and Sustainability</h3>
        <h4 className="text-xl font-semibold mb-4 text-center text-yellow-300">(Months 13-24)</h4>
        <div className="space-y-4 text-center">
          <div>
