          ...
          <div className="flex flex-wrap justify-between items-start">
            ...
            <div className="flex flex-col items-center animate-move m-2 sm:m-4 md:m-6">
              <div className="relative mb-4">
                ...
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0.5 h-6 bg-yellow-500"><p>Objective: Generate awareness, build community, and raise initial capital.
Key Activities:
