...
function LandingPage() {
  ...
  return (
    <>
      ...
      {/* New card */}
      <div className="bg-purple-800 rounded-lg text-white shadow-md overflow-hidden">
      <img src="pantherIcon.jpg" alt="panther" className="w-full h-48 object-cover" />
      <div className="p-4">
        <h3 className="text-xl font-bold text-gray-800">Black Panther Is Set To Rock The Charts</h3>
