  ...
  <section className="bg-purple-950 py-12 px-6 md:px-16 lg:px-24 text-white">
    ...
    <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md relative phase">
        ...
        <h4 className="text-xl font-semibold mb-4">Initial Traction (Months 1-3)</h4> 
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md relative phase">
        ...
        <h4 className="text-xl font-semibold mb-4">Ecosystem Development (Months 4-12)</h4> 
        <ul className="list-disc pl-4 text-justify">
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md relative phase">
        ...
        <h4 className="text-xl font-semibold mb-4">Expansion and Sustainability (Months 13-24)</h4> 
        <ul className="list-disc pl-4 text-justify">
