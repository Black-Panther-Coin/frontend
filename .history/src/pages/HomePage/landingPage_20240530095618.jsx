...
function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      ...
      <div className="absolute bottom-8 right-8 bg-purple-600 p-6 rounded-lg shadow-lg w-full max-w-xs md:max-w-sm flex flex-col items-center justify-center">
        ...
        <div className="mt-4 text-center">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <div className="flex mt-2">
              <input type="text" className="border rounded-l px-4 py-2 w-20" placeholder="USD" />
              <input type="text" className="border rounded-r px-4 py-2 w-20" placeholder="$ BPNTHR" />
            </div>
            <button className="bg-purple-500 text-white py-2 px-4 rounded mt-4 hover:bg-purple-600 focus:outline-none">
              Proceed to Buy
            </button>
          </div>
          <p className="text-white text-xs mt-2 font-bold">NB<span className='text-yellow-500'>NB:</span>: MAKE SURE YOUR WALLET IS SET TO BNB SMARTCHAIN NETWORK (NOT ETHEREUM)</p>
        </div>
      </div>
    </div>
  );
