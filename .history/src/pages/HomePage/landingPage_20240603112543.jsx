    ...
    <div className="mx-auto w-full px-4 bg-purple-950">
        <div className="flex flex-col lg:flex-row justify-between items-center">
          ...
          <div className="w-full lg:w-auto">
            <h2 className="text-6xl font-bold text-yellow-500 mb-4 text-center"></h2>
            <p className="text-2xl text-white "><span className='text-left'>BPNTHR</span>Contract Address:</p>
            <p className="text-2xl cursor-pointer text-center" onClick={copyToClipboard}> {contractAddress}</p>
