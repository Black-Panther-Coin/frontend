...
function LandingPage() {
  ...
  return (
    <>
      ...
      {/* New card */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 lg:left-auto lg:right-24 lg:translate-x-0 bg-purple-950 p-6 rounded-lg shadow-lg w-full max-w-md mx-auto flex flex-col items-center">
        <div className="flex justify-between items-center">
          {/* <div className="w-1/2">
            <img src={pantherIcon} alt="Panther Icon" className="w-24 h-auto mx-auto" />
          </div> */}
          <div className="w-1/2">
            <button className="bg-yellow-500 text-black py-2 px-4 font-bold rounded hover:bg-yellow-600 focus:outline-none">
              Join Pre-Sale
            </button>
          </div>
        </div>
