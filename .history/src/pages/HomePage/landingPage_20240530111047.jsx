...
import pantherImage from '../../assets/images/pantherimage.png'; // Adjust the path if necessary
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      <div className="absolute top-0 left-0 h-full w-1/3 flex justify-center items-center">
        {/* Adjusted the img tag here */}
        <img src={pantherImage} alt="Left Side Image" className="h-7/12 object-cover -mt-12" />
      </div>
      ...
      <div className="absolute bottom-8 right-80 bg-purple-950 p-6 rounded-lg shadow-lg w-full max-w-xs md:max-w-sm flex flex-col items-center justify-center">
        ...
        <div className="mt-4 text-center">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <div className="flex mt-2">
              <input type="text" className="border text-black font-bold rounded-l px-4 py-2 w-40 h-20 bg-lightbaige" placeholder="USD" />
              <input type="text" className="border text-black font-bold rounded-r px-4 py-2 w-40 h-20 bg-lightbaige" placeholder="$ BPNTHR" />
            </div>
      ...
      {/* Contract Address Section with margin */}
      {/* <div className="bg-purple-950 text-white p-3 mt-6 rounded-lg absolute bottom-0 w-full text-center">
