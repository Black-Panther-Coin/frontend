  ...
  <section className="bg-purple-950 py-12 px-6 md:px-16 lg:px-24 text-white">
    ...
    <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md">
        <h3 className="text-2xl font-bold mb-4">Phase 1: Initial Traction (Months 1-3)</h3>
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md">
        <h3 className="text-2xl font-bold mb-4">Phase 2: Ecosystem Development (Months 4-12)</h3>
        <ul className="list-disc pl-4">
      ...
      <div className="bg-purple-800 rounded-lg p-6 shadow-md">
        <h3 className="text-2xl font-bold mb-4">Phase 3: Expansion and Sustainability (Months 13-24)</h3>
        <ul className="list-disc pl-4">
      ...
      {/* Arrow linking Phase 1 to Phase 3 */}
      <svg className="absolute w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
        <line x1="10" y1="25" x2="90" y2="75" stroke="yellow" strokeWidth="2" markerEnd="url(#arrowhead)" />
        <defs>
