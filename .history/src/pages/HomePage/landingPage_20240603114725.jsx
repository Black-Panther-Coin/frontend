  ...
  return (
    <>
      ...
      <div className="card-image">
        <img src="harambe.jpg" alt="Harambe Monkey" />
      </div>
      <div className="card-content">
        <h3 className="card-title">Harambe Is Set To Rock The Charts</h3>
        <p>With a Whopping 100% ROI (This Year Alone!)</p>
        <p>Each successful trade triggers the purchase and immediate burning of Harambe Tokens, increasing demand, reducing supply, and driving prices to the moon.</p>
        <a href="#" className="button">GET MY TOKENS</a>
        <p>1 HARAMBE AI = $ 0.309 USD</p>
        <p className="disclaimer">Hurry - Token price increases on May 25th!</p>
      </div>
    </div>
    </>
  );
