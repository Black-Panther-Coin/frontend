  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-purple-900 to-purple-700 opacity-90"></div>
        {/* Background SVG */}
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1920 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Replace with your SVG graphic or use an SVG generator for custom designs */}
          <path d="M1920 1080H0V0L1674.7 1080H1920Z" fill="url(#paint0_linear)" />
          <defs>
            <linearGradient id="paint0_linear" x1="384" y1="0" x2="1920" y2="1080" gradientUnits="userSpaceOnUse">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center mt-8 text-white">
        <div className="lg:w-1/2 lg:mx-auto mb-4 lg:mb-8">
          <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-white px-4">
            Black Panther Token (<span className="text-yellow-500">BPNTHR</span>) Pre-Sale is Live
          </h1>
          <p className="mt-2 sm:mt-4 text-base font-semibold">A MEME COIN WITH PURPOSE!</p>
        </div>
      ...
      {/* Action bar */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 lg:left-auto lg:right-24 lg:translate-x-0 bg-purple-900 p-6 rounded-lg shadow-lg w-full max-w-md mx-auto flex flex-col items-center justify-center">
        ...
        <div className="mt-4 text-center">
          ...
          <p className="text-sm mt-2 text-gray-200">Please go to your Wallet Address and CUSTOM IMPORT the BPNTHR ticker by copying the Contract Address inside your wallet in order to view the number of tokens you have bought.</p>
