...
//import { FaRocket, FaCogs, FaExpand } from 'react-icons/fa';
import { ReactComponent as RocketIcon } from './icons/rocket.svg'; // Assuming you have these SVG files
  ...
  <section className="bg-purple-950 py-12 px-6 md:px-16 lg:px-24 text-white">
    ...
    <div className="relative flex flex-col lg:flex-row justify-center items-stretch space-y-8 lg:space-y-0 lg:space-x-8">
      ...
      <div className="relative flex-1 flex flex-col items-center">
        ...
        <div className="absolute h-full border-l-2 border-yellow-500 transform translate-x-8 lg:translate-x-0 lg:translate-y-8 lg:rotate-90"></div>
