    ...
    <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4">
      <div className="lg:w-1/2 text-center lg:text-left">
        ...
        <p className="text-white text-base lg:text-lg leading-relaxed text-justify">
          a revolutionary Web3/Blockchain crypto initiative inspired by the powerful symbolism of the African Black Panther legend. Our mission is to leverage the transformative power of blockchain technology to address critical issues arising across Africa and the  African diaspora, addressing issues of health and wellness with a focus on food as medicine, alternative treatments and research and development as well as crypto finance literacy. 
        </p>
      </div>
