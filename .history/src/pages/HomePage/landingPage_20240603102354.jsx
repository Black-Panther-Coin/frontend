  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      ...
      <div className="absolute left-8 bottom-8 flex items-end">
        <img src={pantherImage} alt="Black Panther" className="w-full h-auto mb-8" /> {/* Reduced image size */}
      </div>

      <div className="absolute bottom-8 right-24 bg-purple-950 p-6 rounded-lg shadow-lg w-full max-w-md mx-auto flex flex-col items-center justify-center min-h-[500px]"> {/* Increased card height */}
