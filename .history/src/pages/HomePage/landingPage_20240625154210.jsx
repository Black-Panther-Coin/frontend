...
const Header = () => {
  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden bg-lightbeige">
      {/* Background graphics with mouse movement */}
      <div className="absolute inset-0 z-0">
        {/* Decorative shapes */}
        <div className="shape absolute top-10 left-10 w-16 h-16 bg-purple-600 opacity-50 rounded-full mix-blend-multiply" data-speed="0.05"></div>
        <div className="shape absolute bottom-10 right-10 w-24 h-24 bg-yellow-400 opacity-50 rounded-full mix-blend-multiply" data-speed="0.03"></div>
        <div className="shape absolute top-1/4 left-1/3 w-20 h-20 bg-purple-300 opacity-50 rounded-full mix-blend-multiply" data-speed="0.07"></div>
        <div className="shape absolute bottom-1/3 right-1/4 w-12 h-12 bg-yellow-500 opacity-50 rounded-full mix-blend-multiply" data-speed="0.09"></div>
        {/* Add more shapes or crypto-themed elements here */}
      </div>
