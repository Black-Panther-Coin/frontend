  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-900 via-purple-700 to-yellow-500 opacity-80"></div>
        {/* Background decorative shapes */}
        <div className="absolute top-0 left-0 w-1/2 h-1/2 bg-purple-600 opacity-50 rounded-full mix-blend-multiply"></div>
        <div className="absolute bottom-0 right-0 w-1/3 h-1/3 bg-yellow-400 opacity-50 rounded-full mix-blend-multiply"></div>
        <div className="absolute top-1/3 left-1/3 w-1/4 h-1/4 bg-purple-300 opacity-50 rounded-full mix-blend-multiply"></div>
      </div>
