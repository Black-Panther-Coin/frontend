...
const BuySection = ({ contractAddress, buyImage }) => {
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center">
        ...
        <div className="ml-4">
          ...
          <div className="flex items-center">
            <p className="text-yellow-500 font-semibold">{contractAddress}</p>
            <button onClick={copyToClipboard} className="ml-2 text-white bg-yellow-500 p-2 rounded-full">
              <FaCopy />
            </button>
          </div>
          {copySuccess && <p className="text-xs text-green-500">Copied!</p>}
        </div>
      </div>
    </div>
  );
