    ...
    <>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center">
          ...
          <div className="ml-4">
            ...
            <p className="text-yellow-500 font-semibold" onClick={copyToClipboard}>{contractAddress}
              Contract Address: 0x12a55f6aBDfE13a44eF8b29a24964e20D21E0fA5
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto flex items-center justify-center px-4">
        <div className="text-center lg:text-left flex items-center">
          <div className="text-orange-500 font-bold text-4xl lg:text-6xl leading-none">
            <span className="text-orange-500" style={{ textShadow: "3px 3px #FF6F00" }}>BUY</span>
          </div>
