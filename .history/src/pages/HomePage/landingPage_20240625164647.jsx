...
import './homePage.css'; // Make sure to import your custom CSS



const RoadMap = () => {
  const currentStage = 2; // Change this value to mark the current stage

  return (
    <section className="bg-purple-950 py-12 px-6 md:px-16 lg:px-24 text-white bg-bg2">
      ...
      <div className="relative flex flex-col lg:flex-row justify-center items-stretch space-y-8 lg:space-y-0 lg:space-x-8">
        ...
        <div
          className={`bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center text-center relative mb-8 lg:mb-0 z-10 transform transition-transform duration-200 hover:scale-105 animate-slideInLeft ${currentStage === 1 ? 'current-stage' : ''}`}
        >
        ...
        <div
          className={`bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center text-center relative mb-8 lg:mb-0 z-10 transform transition-transform duration-200 hover:scale-105 animate-slideInRight ${currentStage === 2 ? 'current-stage' : ''}`}
        >
          <div className="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center text-purple-800 text-2xl font-bold mb-4">
            02
          </div>
        ...
        <div
          className={`bg-purple-800 rounded-lg p-6 shadow-md flex flex-col items-center text-center relative z-10 transform transition-transform duration-200 hover:scale-105 animate-slideInLeft ${currentStage === 3 ? 'current-stage' : ''}`}
        >
          <div className="w-16 h-16 bg-yellow-400 rounded-full flex items-center justify-center text-purple-800 text-2xl font-bold mb-4">
            03
          </div>
