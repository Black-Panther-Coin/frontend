...
const Header = () => (
  <div className="relative min-h-[60vh] overflow-hidden bg-lightbaige">
    <div className="flex flex-col lg:flex-row justify-center items-center h-full text-center lg:text-left mt-8">
      <div className="lg:w-1/2 mb-4 lg:mb-0 lg:pr-4 flex justify-center">
        <img src="/path/to/your/image.png" alt="Black Panther Token" className="max-w-full h-auto"/>
      </div>
