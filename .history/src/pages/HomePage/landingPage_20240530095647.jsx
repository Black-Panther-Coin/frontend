    ...
    <div className="relative min-h-screen overflow-hidden bg-lightbaige">
      ...
      <div className="absolute bottom-8 right-8 bg-purple-600 p-6 rounded-lg shadow-lg w-full max-w-xs md:max-w-sm flex flex-col items-center justify-center">
        ...
        <div className="mt-4 text-center">
          ...
          <p className="text-white text-xs mt-2 font-bold">NB<span className='text-orange-500'>NB:</span>: MAKE SURE YOUR WALLET IS SET TO BNB SMARTCHAIN NETWORK (NOT ETHEREUM)</p>
        </div>
      </div>
    </div>
  );
