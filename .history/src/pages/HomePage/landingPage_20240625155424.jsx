  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden bg-lightbeige">
      ...
      <div className="absolute inset-0 z-0">
        {/* Decorative shapes */}
        <div className="shape absolute top-0 left-0 w-1/2 h-1/2 bg-purple-600 opacity-20 rounded-full mix-blend-multiply" data-speed="0.05"></div>
        <div className="shape absolute bottom-0 right-0 w-1/3 h-1/3 bg-yellow-400 opacity-20 rounded-full mix-blend-multiply" data-speed="0.03"></div>
        <div className="shape absolute top-1/3 left-1/3 w-1/4 h-1/4 bg-purple-300 opacity-20 rounded-full mix-blend-multiply" data-speed="0.07"></div>
      </div>
