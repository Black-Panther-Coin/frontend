        ...
        <div className="mt-4 text-center">
          ...
          <div className="mt-4 flex flex-col items-center">
            ...
            <div className="flex mt-2">
              <input type="text" className="border rounded-l px-4 py-2 w-24 h-10 bg-lightbaige" placeholder="USD" />
              <input type="text" className="border rounded-r px-4 py-2 w-24 h-10 bg-lightbaige" placeholder="$ BPNTHR" />
            </div>
