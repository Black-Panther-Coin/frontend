  ...
  return (
    ...
    <div className=" mx-auto w-full px-4 bg-purple-950">
        <div className="flex justify-between items-center">
          ...
          <div className="w-1/2">
            <h2 className="text-2xl font-bold text-yellow-500 mb-4 text-center">BPNTHR Contract address:<br /> rtdytfyghfggfdrredrfdfrererdf454f</h2>
          </div>
          
        </div>
      </div>

    <div className="mt-16 mx-auto w-full px-4 bg-purple-600">
        <div className="flex justify-between items-center">
          <div className="w-1/2">
