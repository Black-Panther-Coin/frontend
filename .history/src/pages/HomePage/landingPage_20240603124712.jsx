...
function LandingPage() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center h-full text-center lg:text-left ml-1/3 mt-16 lg:ml-0 lg:pl-16">
        <div className="mb-8 lg:mb-0 lg:w-1/2">
          <img src="path-to-black-panther-image.png" alt="Black Panther" className="mx-auto lg:mx-0" />
        </div>
        <div className="flex flex-col justify-center items-center lg:items-start text-center lg:text-left lg:w-1/2">
      ...
      <div className="mx-auto w-full px-4 bg-purple-950">
        <div className="flex flex-col lg:flex-row justify-between items-center">
          ...
          <p className="text-2xl text-white text-left font-bold">Contract Address:</p>
            <p className="text-yellow-500 font-semibold" onClick={copyToClipboard}>{contractAddress}
