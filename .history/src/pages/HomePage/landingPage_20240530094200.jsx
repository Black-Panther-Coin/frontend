...
function LandingPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-lightbeige">
      ...
      <div className="absolute bottom-4 right-4 bg-white p-6 rounded-lg shadow-lg w-full max-w-xs md:max-w-sm flex flex-col items-center justify-center">
        ...
        <div className="mt-4 text-center">
          ...
          <div className="mt-4 flex flex-col items-center">
            <label className="text-gray-600">How many BPNTHR would you like to buy?</label>
