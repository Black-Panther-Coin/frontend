  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden bg-lightbeige">
      ...
      <div className="absolute inset-0 z-0">
        {/* Decorative shapes */}
        <div className="absolute top-0 left-0 w-1/2 h-1/2 bg-purple-600 opacity-20 rounded-full mix-blend-multiply"></div>
        <div className="absolute bottom-0 right-0 w-1/3 h-1/3 bg-yellow-400 opacity-20 rounded-full mix-blend-multiply"></div>
        <div className="absolute top-1/3 left-1/3 w-1/4 h-1/4 bg-purple-300 opacity-20 rounded-full mix-blend-multiply"></div>
      </div>
      ...
      {/* Action bar */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 lg:left-auto lg:right-24 lg:translate-x-0 bg-white p-6 rounded-lg shadow-2xl w-full max-w-md mx-auto flex flex-col items-center justify-center">
        ...
        <div className="mt-4 text-center">
          <h2 className="text-purple-950 font-bold">JOIN THE BLACK PANTHER <span className="text-yellow-500">BPNTHR</span> PRE-SALE</h2>
          <p className="text-sm mt-2 text-purple-700">Please go to your Wallet Address and CUSTOM IMPORT the BPNTHR ticker by copying the Contract Address inside your wallet in order to view the number of tokens you have bought.</p>
          ...
          <p className="text-purple-700 text-xs mt-2 font-bold"><span className='text-yellow-500'>NB:</span> MAKE SURE YOUR WALLET IS SET TO BNB SMARTCHAIN NETWORK (NOT ETHEREUM)</p>
        </div>
        ...
        {/* Background overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-600 via-purple-700 to-yellow-500 opacity-10 rounded-lg pointer-events-none"></div>
      </div>
    </div>
  );
};
