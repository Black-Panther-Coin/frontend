  ...
  return (
    ...
    <div className="mx-auto w-full px-4 bg-purple-950">
        <div className="flex justify-between items-center">
          ...
          <div className="w-1/2">
            <h2 className="text-8xl font-bold text-yellow-500 mb-4 text-center">BPNTHR <span className='text-white text-2xl'>contract address:</span><span className="cursor-pointer text-2xl" onClick={copyToClipboard}> {contractAddress}</span></h2>
